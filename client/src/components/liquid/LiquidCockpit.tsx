  ...
  return (
    <div className="w-full space-y-4">
        ...
        <div className="flex items-center justify-between border-b border-stone-800 pb-3">
          <div className="flex items-center bg-stone-900 border border-stone-800 rounded-xl p-1 gap-1">
            ...
            >
              ...
              <span>
                {isGerman
                  ? "✍️ Neuer Entwurf (Live-KI)"
                  : "✍️ Live Draft (Vertex AI)"}
              </span>
            </button>
            ...
            >
              ...
              <span>
                {isGerman ? "📂 Archiv-Dossiers" : "📂 Dossier Archive"}
              </span>
            </button>
          </div>
          ...
          <div className="text-xs text-stone-500 font-mono hidden sm:block">
            {activeTab === "draft"
              ? isGerman
                ? "Direkte Texteingabe • Keine Schein-Daten"
                : "Direct Text Input • Zero Pre-Cached Mock"
              : isGerman
                ? "Gespeicherte redaktionelle Dossiers"
                : "Pre-published Editorial Dossiers"}
          </div>
        </div>
      )}
      ...
      {selectedArticleId ? (
        ...
        <DraftStudio language={language} onLanguageChange={onLanguageChange} />
      ) : (
        <ArticleFeed
          language={language}
