...
export const CreateArticleModal: React.FC<CreateArticleModalProps> = ({
  ...
  const submitImport = async (event: React.FormEvent) => {
    ...
    try {
      ...
      setError(
        cause instanceof Error ? cause.message : "Unable to import article",
      );
    } finally {
      setBusy(false);
    }
    ...
    try {
      ...
      if (visualize) {
        window.history.pushState(
          {},
          "",
          `/articles/${outcome.article.id}?visualize=1`,
        );
      ...
      setError(
        cause instanceof Error ? cause.message : "Unable to create article",
      );
    } finally {
      setBusy(false);
    }
      ...
      >
          ...
          <div className="modal-title-wrap">
            ...
            <div>
              <h2 className="modal-title">
                {mode === "create" ? "Create Article" : "Import Article"}
              </h2>
        ...
        {mode === "import" ? (
          <form
            ...
            className="editor-scroll-body article-import-form"
          >
            ...
            <p className="helper-text">
              JSON files must follow the supplied NZZ article structure.
              Markdown requires a headline and article body; optional front
              matter can provide author, section, language, date, and source
              URL.
            </p>
